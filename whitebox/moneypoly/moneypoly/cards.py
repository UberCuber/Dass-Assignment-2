""" 
Cards module defines the chance cards and community chest cards.
It also gives the CardDeck class which handles operations like
shuffling the card deck etc.
"""
