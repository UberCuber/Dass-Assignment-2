"""Bank module for handling all kinds of money transactions with the bank."""

from moneypoly.config import BANK_STARTING_FUNDS

class Bank:
    """
    Defines the funds available to the bank, number of loans issued,
    total amount of money collected. Also defines all bank operations.
    """
    def __init__(self):
    ...
    def give_loan(self, player, amount):
        ...
        self._loans_issued.append((player.name, disbursed))
        print(f"  Bank issued a ${disbursed} emergency loan to {player.name}.")
