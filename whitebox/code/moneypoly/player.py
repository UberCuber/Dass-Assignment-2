""" 
Player module defines the player class which represents a single player in the game. 
It defines all the player functions in the game.
"""
...
class Player:
    ...
    def move(self, steps):
        ...
        if steps > 0 and (self.position == 0 or self.position < old_position):
